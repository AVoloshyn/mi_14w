...
#include "../../LauncherApp/src/clauncherhandler.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CLauncherHandler_t, stringdata) + ofs \
...
void *CLauncherHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLauncherHandler.stringdata))
